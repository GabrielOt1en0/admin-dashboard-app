    ...
    <div className="flex h-screen bg-muted/30 overflow-hidden">
      ...
      <aside className="w-64 bg-[#0F172A] border-r border-slate-800 flex flex-col hidden md:flex">
        ...
        <nav className="flex-1 py-6 px-4 space-y-1 overflow-y-auto">
          ...
          <NavItem icon={Users} label="Players" active={activeTab === "players"} onClick={() => setActiveTab("players")} />
          <NavItem icon={UserCheck} label="Scouts" active={activeTab === "scouts"} onClick={() => setActiveTab("scouts")} />
          <NavItem icon={Calendar} label="Matches & Events" active={activeTab === "events"} onClick={() => setActiveTab("events")} />
